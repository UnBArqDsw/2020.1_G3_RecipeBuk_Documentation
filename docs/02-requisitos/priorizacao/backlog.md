...
|------|--------|-----------|--------|
|**EP01 - Usuário**|**FE01 - Autenticação**|**US01:** Eu, como usuário, gostaria de realizar o cadastro / login no site para ter pleno acesso às funcionalidades.|**Must**|
| | |**US02:** Eu, como usuário, gostaria de deletar a minha conta no site para cancelar o meu uso no site.|**Should**|
|||**US03:** Eu, como usuário, gostaria de usar as redes sociais para fazer o cadastro / login no site para facilitar o processo de autenticação.|**Should**|
|||**US04:** Eu, como usuário, gostaria de editar a minha conta para atualizar as minhas informações de autenticação.|**Should**|
||**FE02 - Perfil**|**US05:** Eu, como usuário, gostaria de editar meu perfil para poder atualizar minhas informações pessoais.|**Must**|
||**FE03 - Feedback**|**US06:** Eu, como usuário, gostaria de fornecer sugestões de sites a serem incluídos em pesquisas para obter resultados com maior variedade.|**Would**|
|||**US07:** Eu, como usuário, gostaria de fornecer feedback para a melhoria do site.|**Would**|
|**EP02 - Receitas**|**FE04 - Criação**|**US08:** Eu, como usuário, gostaria de cadastrar receitas para poder armazená-las em meu perfil.|**Must**|
|||**US09:** Eu, como usuário, gostaria de deletar receitas da minha conta para poder retirá-las do site.|**Must**|
|||**US10:** Eu, como usuário, gostaria de editar as minhas receitas para poder atualizar o conteúdo delas.|**Must**|
|||**US11:** Eu, como usuário, gostaria de cadastrar minhas receitas por voz para conseguir utilizar o site de formas mais diversas.|**Would**|
||**FE05 - Busca**|**US12:** Eu, como usuário, gostaria de buscar uma receita para obter informações acerca do preparo da mesma.|**Must**|
|||**US13:** Eu, como usuário, gostaria de buscar uma receita no próprio site para ter um acesso a informações delas.|**Must**|
|||**US14:** Eu, como usuário, gostaria de buscar receitas em minhas conta para ter maior facilidade em achar as suas informações.|**Should**|
|||**US15:** Eu, como usuário, gostaria de adicionar ingredientes alternativos para as receitas para que as pessoas possam flexibilizar o seu preparo.|**Could**|
||**FE06 - Visualização**|**US16:** Eu, como usuário, gostaria de visualizar receitas para que eu possa ter acesso às informações delas.|**Must**|
